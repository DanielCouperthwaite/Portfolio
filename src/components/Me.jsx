        ...
        <>
            <div className="container mx-auto max-w-7xl px-6 lg:px-4 py-20">
                <div className="mx-auto max-w-2xl">
                    ...
                    <p className="mt-6 text-lg leading-8">
                        I am growing my development skills every day and would love the chance to do this in a team as a junior developer. You can see some of the projects I have made below, or follow updates from my linkedIn account.
                    </p>
                    <p className="mt-6 text-lg leading-8">
